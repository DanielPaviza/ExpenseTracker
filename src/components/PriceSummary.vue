...
const total = computed(() =>
  spendings.reduce((sum, s) => sum + (s.UnitPrice * s.Quantity), 0)
);
...
<template>
  <section class="mb-8">
    <div class="bg-white dark:bg-black rounded-lg shadow p-6 flex flex-col gap-4 items-center">
      <div class="text-2xl font-bold">Celková cena: <span class="text-blue-700">{{ total.toLocaleString() }} Kč</span></div>
